...
//    public RestResponse<String> systemLogin(String owner, String random, long time, String transactionId) {
//        RestResponse.Builder builder = new RestResponse.Builder();
//        if (StringUtils.isEmpty(owner)) {
//
//            builder.setMsg("owner is empty.");
//            builder.setCode(403);
//            return builder.build();
//        }
//        StringBuilder builder1 = new StringBuilder();
//        String baseStr = builder1.append(owner + ",").append(random + ",").append(time).toString();
//        String sha256 = ConvertUtil.getSHA256(baseStr);
//        UserInfo userInfo = userInfoService.findByUsername(owner);
//        if (null == userInfo) {
//            builder.setMsg("owner does not exist.");
//            builder.setCode(403);
//            return builder.build();
//        }
//        String message = ParamApi.check(transactionId, code, code, "notetaker", url, owner);
